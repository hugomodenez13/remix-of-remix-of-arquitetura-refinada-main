      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        >
          <motion.h2
            ...
            className="font-display text-3xl md:text-4xl lg:text-5xl font-medium text-primary-foreground leading-tight mb-6"
          >
            Pronto para transformar suas ideias em{" "}
          ...
          >
            Cada projeto começa com uma conversa. Vamos discutir suas necessidades, 
            sonhos e como podemos criar juntos um espaço que seja verdadeiramente seu.
          </motion.p>
